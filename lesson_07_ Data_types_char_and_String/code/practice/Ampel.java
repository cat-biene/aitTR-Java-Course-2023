package practice;
//Напишите программу для машины на светофоре. Что нужно делать,
// если горит красный, жёлтый или зелёный свет.
...
public class Ampel {
    ...
    // либо цифрами 1,2,3, либо пользователь вводит строку, либо задаем в программе строкой (переменная типа String)
        ...
        switch (color) {
            ...
            case "Yellow" -> System.out.println("Be read to go.");
