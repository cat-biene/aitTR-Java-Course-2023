...
public class PredicateTest {
    ...
    public static void main(String[] args) {
        ...
        Predicate<Integer> isPositive = x -> x > 0; // объявили предикат и сразу вписали в него условие, которое будет проверяться
        ...
        System.out.println(containsJava.test("Hello Java ")); // true
        System.out.println(containsJava.test("Hello Jav ")); // false
