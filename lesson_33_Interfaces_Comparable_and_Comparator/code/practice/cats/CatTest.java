...
class CatTest {
    ...
    void setUp() {
        ...
        cat[2] = new Cat(103, "Murzik", "pers", 9, 5.1);
    ...
    void testCatSort() {
        ...
        printArray(cat);// печатаем массив как есть не отсортированный
    ...
    void testCatSortComparator() {
        ...
        Comparator<Cat> catComparator = new Comparator<Cat>() {
            ...
            public int compare(Cat o1, Cat o2) {
                return o1.getName().compareTo(o2.getName()); // сравнили по именам (поле )
            }
        };

        printArray(cat); // печатаем массив как есть, не сортированный
    ...
    void testCatSortComparator2() {
        ...
        Comparator<Cat> catComparator = new Comparator<Cat>() {
            @Override
            public int compare(Cat o1, Cat o2) {
                return o1.getAge() - o2.getAge(); // сравнили по именам (поле )
            }
        };
