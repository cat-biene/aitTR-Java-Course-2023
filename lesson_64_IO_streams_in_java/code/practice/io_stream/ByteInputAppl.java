...
public class ByteInputAppl {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        try {
            /*System.out.println("Available: " + fin.available()); // выясняем сколько бйт доступно для чтения
            int a = fin.read(); // считали 1 байт
            System.out.println(a); // напечатали
            System.out.println("Available: " + fin.available()); // выясняем сколько байт допустимо для чтения
            // каждое чтение байта из файла перемещает "внутренний курсор" на одну позицию

            a = fin.read(); // считали 1 байт
            System.out.println(a); // напечатали
