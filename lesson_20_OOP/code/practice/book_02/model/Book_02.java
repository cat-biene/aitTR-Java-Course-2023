package practice.book_02.model;
...
public class Book_02 {
    ...
    public Book_02(long isbn, String title, String author, int yearOfPublishing) {
    ...
    public Book_02(long isbn, String title, int yearOfPublishing) {
        this.isbn = checkIsbn(isbn);
        this.title = title;
        this.yearOfPublishing = yearOfPublishing;
        author = "unknown";
