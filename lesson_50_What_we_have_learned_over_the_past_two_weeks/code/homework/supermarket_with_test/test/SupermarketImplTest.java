...
public class SupermarketImplTest {
    ...
    void setUp() {
        ...
        products = new Product_01[5];
        products[0] = new Product_01(111111, "White Bread", "Bread", "Kolosok", 6.5, now.plusDays(5));
        products[1] = new Product_01(222222, "ChokoMilk", "Dairy", "MilkLand", 13, now.minusDays(3));
        products[2] = new Product_01(333333, "Cheese Gauda", "Dairy", "Farmer", 22.5, now.plusDays(50));
        products[3] = new Product_01(444444, "Cheese Chedder", "Dairy", "MilkLand", 30, now.plusDays(85));
        products[4] = new Product_01(555555, "Sweet Buns", "Bread", "Kolosok", 18.3, now.minusDays(25));
    ...
    void addProductTest() {
        ...
        Product_01 product1 = new Product_01(666666, "Sweet Buns", "Bread", "Kolosok", 18.3, now.minusDays(25));
        assertTrue(myMarket.addProduct(product1));
        assertEquals(6, myMarket.skuQuantity());
        Product_01 product2 = new Product_01(666666, "Sweet Buns", "Bread", "Kolosok", 18.3, now.minusDays(25));
        assertFalse(myMarket.addProduct(product2)); // с одиноковым баркодом
        Product_01 product3 = new Product_01(777777, "Sweet Buns", "Bread", "Kolosok", 18.3, now.minusDays(25));
    ...
    void findByBrandTest() {
        ArrayList<Product_01> actual = (ArrayList<Product_01>) myMarket.findByCategory("bread");
        // надо перенести actual в массив
        int l = actual.size(); // определил длину массива
        Product_01[] productsActual = new Product_01[l];  // создал массив элементов типа Product длины l
        // заполнил созданный массив
        for (int i = 0; i < l; i++) {
            productsActual[i] = actual.get(i);
        }
        Product_01[] expected = {products[0], products[4]}; //
