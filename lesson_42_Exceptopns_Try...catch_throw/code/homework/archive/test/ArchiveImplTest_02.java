package homework.archive.test;

import homework.archive.dao.ArchiveImpl_02;
import homework.archive.dao.Archive_02;
...
public class ArchiveImplTest_02 {
    Archive_02 archive;
    Document_02[] d;
...
//        ph[5] = new Photo(1, 4, "title4", "url1", LocalDateTime.of(now.minusDays(2).toLocalDate(), LocalTime.MAX));
        ...
        d[0] = new Document_02(1,1,"t1","url1",now.minusDays(2));
        d[1] = new Document_02(1,2,"t2","url2",now.minusDays(3));
        d[2] = new Document_02(1,3,"t3","url3",now.minusDays(5));
        d[3] = new Document_02(2,4,"t1","url4",LocalDateTime.of(now.minusDays(7).toLocalDate(), LocalTime.MIN));
        d[4] = new Document_02(2,5,"t2","url5",LocalDateTime.of(now.minusDays(7).toLocalDate(), LocalTime.MIN));
        d[5] = new Document_02(1,6,"t3","url6",LocalDateTime.of(now.minusDays(7).toLocalDate(), LocalTime.MIN));
    ...
    void addDocumentTest() {
        ...
        Document_02 doc = new Document_02(3,1,"t7","url",now);
        ...
        doc = new Document_02(3,1,"t7","url",now);
    ...
    void getAllDocFromFolderTest() {
        Document_02[] expected = {d[3],d[4]};
        Document_02[] actual = archive.getAllDocFromFolder(2);//выбрали folderId = 2
    ...
    void getDocBetweenDateTest() {
        ...
        Document_02[] actual = archive.getDocBetweenDate(ld.minusDays(7), ld.minusDays(3));
        Arrays.sort(actual);
        Document_02[] expected = {d[1],d[2],d[3], d[4], d[5]};
