...
class CityTest {
    ...
    void setUp() {
        ...
        cities[2] = new City( "Chicago", 2_700_000, "USA",6.8 );
        cities[3] = new City( "Atlanta", 470_000, "USA",8 );
        cities[4] = new City( "New York", 8_500_000 , "USA",6.5);
        cities[5] = new City( "Dallas", 1_300_000, "USA",3 );
    }
    ...
    void testComparator() {
        ...
        Comparator<City> comparator1 = (c1, c2) -> Double.compare(c2.getIndex(), c1.getIndex());
