...
public class ArchiveAppl {
    ...
    public static void main(String[] args) {
        ...
        ArchiveImpl archive = new ArchiveImpl("lesson 72/proekt/application/documents.csv");
    ...
    private static void addDocument(Scanner scanner, ArchiveImpl archive) {
        try {
            ...
            Documents document = new Documents(folderId, documentId, title, url, annotation, currTime);
    ...
    private static void findDocument(Scanner scanner, ArchiveImpl archive) {
        try {
            ...
            System.out.println("Input document ID: ");
            int documentId = scanner.nextInt();
            Documents document = archive.getDocumentsFromFolder(folderId, documentId);
            if (document != null) {
    ...
    private static void findDocumentByTime(Scanner scanner, ArchiveImpl archive) {
        try {
            ...
            List<Documents> documents = archive.getAllDocumentBetweenDate(startDate, endDate);
    ...
    private static void findDocumentByKeyWord(Scanner scanner, ArchiveImpl archive) {
        try {
            ...
            List<Documents> foundDocuments = archive.findDocumentByKeyWord(keyword);
