...
public class Computer_02 {
    ...
    public Computer_02(String cpu, int ram, int ssd, String brand) {
        super();
        this.cpu = cpu;
        this.ram = ram;
        this.ssd = ssd;
    ...
    public boolean equals(Object object) {
        if (!(object instanceof Computer_02)) {
            return false;
        }
        Computer_02 other = (Computer_02) object;
